...
form.addEventListener("submit", async function (e) {
    ...
    const barangBaruId = Number(barangSelect.value);
    ...
    if (transaksiLama.barang_id === barangBaruId) {
        ...
        const stokSetelahDikembalikan =
            barangLama.jumlah +
            transaksiLama.jumlah;


        if (stokSetelahDikembalikan < jumlahBaru) {
        ...
        if (barangBaru.jumlah < jumlahBaru) {
    ...
    Swal.fire({
        ...
        text: "Barang keluar berhasil diperbarui."
